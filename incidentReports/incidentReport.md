...
The event was detected through an employee observing the Grafana logs. The team started working on the event by inspecting the responses returned from the Pizza Factory. This significant incident affected 100% of users purchasing pizza while active
